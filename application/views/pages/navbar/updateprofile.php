...
<section style="background-color: #e9ecef; min-height: 75vh; padding-top: 80px">
  <div class="container">
    ...
    <!--div class="p-5 text-center bg-image" style="background-image: url('imgs/white.png'); height: 300px; width: auto;"-->
      ...
      <div class="justify-content-center align-items-center h-100 ms-5 me-5">
        ...
        <?php
          ...
          while ($row = mysqli_fetch_array($result)) {
            echo '<img style="width: 200px; height: 200px; border-radius: 100px;" src="data:image/jpeg;base64, ' . base64_encode($row['user_displayImage']) . '"';
          }
        ?>
