<section class="text-light p-5 text-center text-sm-start" style="background-color:#A9A9A9;">
  ...
  <div class="main">
    ...
    <p>By accessing, you confirm that you are in agreement with and bound by the terms of service contained in the Terms & Conditions outlined below. These terms apply to the entire website and any email or other type of communication between you and
      ...
      will not be responsible for any outcome that may occur during the course of usage of our resources. We reserve the rights to remove posts and notes that violate the terms and policy at any moment without any notice.
    </p>
    <hr>
    ...
    <ul>For this Terms & Conditions:</div>
    ...
    <p>We've updated our Terms & Conditions to provide you with complete transparency into what is being set when you visit our site and how it's being used. By using our service, registering an account, you hereby consent to our Terms & Conditions.
    </p>
    <hr>
