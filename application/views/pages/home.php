        ...
        <div class="row g-4 justify-content-center">
            <div class="col-md-4 col-lg-3">
                <div class="card bg-dark">
                    <div class="card-body text-center">
                        <img src="assets/Homepage/guevarra.jpg" class="rounded-circle mb-3 img-fluid" style=" border: 5px solid #333333; 
            ...
            <div class="col-md-4 col-lg-3">
                <div class="card bg-dark">
                    <div class="card-body text-center">
                        <img src="assets/Homepage/bagasona.jpg" class="rounded-circle mb-3 img-fluid" style=" border: 5px solid #333333; 
            ...
            <div class="col-md-4 col-lg-3">
                <div class="card bg-dark">
                    <div class="card-body text-center">
                        <img src="assets/Homepage/romero.jpg" class="rounded-circle mb-3 img-fluid" style=" border: 5px solid #333333; 
            ...
            <div class="col-md-4 col-lg-3">
                <div class="card bg-dark">
                    <div class="card-body text-center">
                        <img src="assets/Homepage/yusoph.jpg" class="rounded-circle mb-3 img-fluid" style=" border: 5px solid #333333; 
            ...
            <div class="col-md-4 col-lg-3">
                <div class="card bg-dark">
                    <div class="card-body text-center">
                        <img src="assets/Homepage/camanag.jpg" class="rounded-circle mb-3 img-fluid" style=" border: 5px solid #333333; 
            ...
            <div class="col-md-4 col-lg-3">
                <div class="card bg-dark">
                    <div class="card-body text-center">
                        <img src="assets/Homepage/pinpin.jpg" class="rounded-circle mb-3 img-fluid" style=" border: 5px solid #333333; 
            ...
            <div class="col-md-4 col-lg-3">
                <div class="card bg-dark">
                    <div class="card-body text-center">
                        <img src="assets/Homepage/estrella.jpg" class="rounded-circle mb-3 img-fluid" style=" border: 5px solid #333333; 
